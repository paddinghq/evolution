      ...
      <div className="bg-[#21787333] p-8 rounded-2xl flex flex-col gap-10">
        <div className="filter flex justify-between items-center">
          <div className="flex items-center gap-6">
            <h3>Filter: </h3>
            <Input className="rounded-3xl" type="text" placeholder="Category" />
            <Input
            ...
            >
              <div className="relative ">
                <Image
                  ...
                  className="block"
                />
                <button className="p-2 options absolute top-3  right-14 flex justify-center rounded-full bg-white">
                  <CiSaveUp2 size={22} className="" />
                </button>
                <button className="p-2 options absolute top-3  right-3 flex justify-center rounded-full bg-[#D41212] text-white">
              ...
              <div className="flex flex-col gap-3 ">
                <div className="relative ">
                  ...
                  <button className="absolute top-[0.3rem] right-[-9px]">
