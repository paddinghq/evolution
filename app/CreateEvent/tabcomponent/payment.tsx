    ...
    <div className="flex rounded-lg flex-col gap-8 px-9 py-8 text-black">
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="">
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="space-y-4">
                <FormLabel>
                  Select payment methods to link with this Event:
                </FormLabel>
                <FormControl>
                  <RadioGroup
          ...
          />
          <p className="mt-5">
            Note: These payment methods are the one's added to your Evolution
            account. Add more methods to your profile to get more options here.
          </p>
        </form>
      </Form>
    </div>
