    ...
    return (
        <div className="px-36 py-5">
            <div className="container">
                <h1 className="text-[#B1761F] font-bold text-3xl font-[]">Organizers to follow</h1>
                <hr className="w-[5.5rem] border-4 border-[#F5A42C] rounded-xl mt-1" />
            </div>

            <div className="mt-4">
                <div className=" grid grid-flow-col overflow-x-scroll gap-4">
                    {organizer.map((items) => 
                        <div className="bg-white rounded-lg shadow-xl flex flex-col items-center px-10 py-10 gap-3">

                            <Image src={items.img.src} alt={items.name} width={100} height={100} />
