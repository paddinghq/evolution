    ...
    return (
        <div className="mt-6 container px-24">
            <div className="relative">
                <Image src={Gift.src} width={1400} height={10} alt="gift" className="rounded-lg "/>
                

                <div className="absolute top-96 px-16 flex flex-col gap-4 text-white">
                    <div className="  text-3xl text-wrap">
                        <h3 >You can now gift tickets to <br /> an event to your friends</h3>
                    </div>
            ...
            <div className="relative mt-10">
                <Image src={Plan.src} width={1400} height={10} alt="gift" className="object-cover"/>
                ...
                <div className="absolute top-96 bg-[#252C2B] text-[#F5FFFE] px-11 py-12 flex flex-col gap-5 rounded-br-3xl rounded-tr-3xl ">
                    ...
                    <p className='text-lg'>Organize exiting events and contribute in all the fun!</p>
